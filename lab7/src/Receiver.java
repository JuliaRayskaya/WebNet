...
public class Receiver implements Runnable, ExceptionListener {
    public void run() {
        try {
            // Создание conneenctionFactory
            ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("admin", "admin", "tcp://127.0.0.1:61616"); //Если мы реализуем //brocker на отдельной машине, то адрес должен быть реальным ip той машины
